...
MongoDB.prototype.create = function(model, data, options, callback) {
  ...
  this.execute(model, 'insertOne', options, data, {safe: true}, function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.save = function(model, data, options, callback) {
  ...
  this.execute(model, 'updateOne', options, {_id: oid}, {$set: data}, {upsert: true}, function(err, result) {
    if (!err) {
...
MongoDB.prototype.destroy = function destroy(model, id, options, callback) {
  ...
  id = self.coerceId(model, id, options);
  this.execute(model, 'deleteOne', options, {_id: id}, function(err, result) {
    if (self.debug) {
...
MongoDB.prototype.all = function all(model, filter, options, callback) {
  ...
  if (fields) {
    ...
    this.execute(model, 'find', options, query, findOpts, processResponse);
  } else {
...
MongoDB.prototype.destroyAll = function destroyAll(
  ...
  this.execute(model, 'deleteMany', options, where || {}, function(err, info) {
...
MongoDB.prototype.count = function count(model, where, options, callback) {
  ...
  this.execute(model, method, options, where, function(err, count) {
    if (self.debug) {
...
MongoDB.prototype.replaceById = function replace(model, id, data, options, cb) {
  ...
  var oid = this.coerceId(model, id, options);
  this.replaceWithOptions(model, oid, data, {upsert: false}, options, function(
    err,
    data
  ) {
    cb(err, data);
...
MongoDB.prototype.replaceWithOptions = function(model, id, data, update, options, cb) {
  ...
  var idName = self.idName(model);
  delete data[idName];
  this.execute(model, 'replaceOne', options, {_id: id}, data, options, function(
    err,
    info
  ) {
