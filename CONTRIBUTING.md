...
Thank you for your interest in `loopback-connector-mongodb-mt`, an open source project
administered by StrongLoop.

Contributing to `loopback-connector-mongodb-mt` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-mongodb-mt)
